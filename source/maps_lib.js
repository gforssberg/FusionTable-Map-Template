...
var MapsLib = {
  ...
  initialize: function() {
    ...
    sliderInterval: function(interval) {
      ...
      if (interval == "quarters") return 3 * 30.4 * 24 * 3600 * 1000;
      ...
      if (interval == "weeks") return 7 * 24 * 3600 * 1000;
      if (interval == "days") return 24 * 3600 * 1000;
      if (interval == "hours") return 3600 * 1000;
      else return 1;
    }
